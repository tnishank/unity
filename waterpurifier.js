#pragma strict
private var id_relay="ARE19";

private var state = 0;
public var water_pure_led: GameObject;
...
function Start()
{
	...
	if (request.error != null)
	{
    		...
    		water_pure_led.gameObject.SetActive(false);
    		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    			state=0;
    			water_pure_led.gameObject.renderer.material.color = Color.red;
    			Debug.Log("device off");
    			}
    		else {
    		  state=1;
    		  water_pure_led.gameObject.renderer.material.color = Color.green;
