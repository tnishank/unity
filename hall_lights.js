...
import SimpleJSON;
private var id_relay="ARE08";
private var state = 0;
public var hall_light1: GameObject;
public var hall_light2: GameObject;
public var hall_light3: GameObject;
...
{	
	...
	if (request.error != null)
	{
    		...
    		hall_light1.gameObject.SetActive (false);
    		hall_light2.gameObject.SetActive (false);
    		hall_light3.gameObject.SetActive (false);
       		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    		  ...
    		  state=1;
    		  hall_light1.gameObject.SetActive (true);
    		hall_light2.gameObject.SetActive (true);
    		hall_light3.gameObject.SetActive (true);
		     }
...
function Update(){
	if (Input.touchCount==1){
				...
				{
					if (hit.collider.gameObject.name == "hall_light_1" || hit.collider.gameObject.name == "hall_light_2" || hit.collider.gameObject.name == "hall_light_3") 
					{
						devicetouched();	
					}
				}
