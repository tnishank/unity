...
private var state = 0;
public var kitchen_first_led: GameObject;
...
function Start()
{
	...
	if (request.error != null)
	{
    		...
    		kitchen_first_led.gameObject.SetActive(false);
    		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    			state=0;
    			kitchen_first_led.gameObject.renderer.material.color = Color.red;
    			Debug.Log("device off");
    			}
    		else {
    		  state=1;
    		  kitchen_first_led.gameObject.renderer.material.color = Color.green;
