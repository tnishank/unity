...
private var state = 0;
public var kitchen_light1: GameObject;
public var kitchen_light2: GameObject;
...
{	
	...
	if (request.error != null)
	{
    		...
    		kitchen_light1.gameObject.SetActive (false);
    		kitchen_light2.gameObject.SetActive (false);
       		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    		  ...
    		  state=1;
    		  kitchen_light1.gameObject.SetActive (true);
    		kitchen_light2.gameObject.SetActive (true);
		     }
...
function Update(){
	if (Input.touchCount==1){
				...
				{
					if (hit.collider.gameObject.name == "cube_light_1" || hit.collider.gameObject.name == "cube_light_2")
					{
						devicetouched();	
					}
				}
