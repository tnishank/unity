#pragma strict
private var id_relay="ARE16";

private var state = 0;
public var kitchen_second_led: GameObject;
...
function Start()
{
	...
	if (request.error != null)
	{
    		...
    		kitchen_second_led.gameObject.SetActive(false);
    		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    			state=0;
    			kitchen_second_led.gameObject.renderer.material.color = Color.red;
    			Debug.Log("device off");
    			}
    		else {
    		  state=1;
    		  kitchen_second_led.gameObject.renderer.material.color = Color.green;
...
function Update(){
	if (Input.touchCount==1){
				...
				{
					if (hit.collider.gameObject.name == "Object016")
					{
						devicetouched();	
					}
				}
