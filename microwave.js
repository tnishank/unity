#pragma strict
private var id_relay="ARE17";

private var state = 0;
public var microwave_led: GameObject;
...
function Start()
{
	...
	if (request.error != null)
	{
    		...
    		microwave_led.gameObject.SetActive(false);
    		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    			state=0;
    			microwave_led.gameObject.renderer.material.color = Color.red;
    			Debug.Log("device off");
    			}
    		else {
    		  state=1;
    		  microwave_led.gameObject.renderer.material.color = Color.green;
