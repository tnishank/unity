...
import SimpleJSON;
private var id_relay="ARE13";
private var state = 0;
public var geyser_led: GameObject;
...
{	
	...
	if (request.error != null)
	{
    		...
    		geyser_led.gameObject.renderer.material.color = Color.red;
    		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    		  ...
    		  state=1;
    		  geyser_led.gameObject.renderer.material.color = Color.green;
		     }
...
function Update(){
	if (Input.touchCount==1){
				...
				{
					if (hit.collider.gameObject.name == "cube_geyzer")
					{
						devicetouched();	
					}
				}
