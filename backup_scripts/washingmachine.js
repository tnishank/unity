#pragma strict
private var id_relay="ARE14";

private var state = 0;
public var washingmachine_led: GameObject;
...
function Start()
{
	...
	if (request.error != null)
	{
    		...
    		washingmachine_led.gameObject.SetActive(false);
    		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    			state=0;
    			washingmachine_led.gameObject.renderer.material.color = Color.red;
    			Debug.Log("device off");
    			}
    		else {
    		  state=1;
    		  washingmachine_led.gameObject.renderer.material.color = Color.green;
