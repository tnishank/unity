...
import SimpleJSON;
private var id_relay="ARE01";
private var state = 0;
public var mb_light1: GameObject;
public var mb_light2: GameObject;
...
{	
	...
	if (request.error != null)
	{
    		...
    		mb_light1.gameObject.SetActive (false);
    		mb_light2.gameObject.SetActive (false);
       		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    		  ...
    		  state=1;
    		  mb_light1.gameObject.SetActive (true);
    		mb_light2.gameObject.SetActive (true);
		     }
