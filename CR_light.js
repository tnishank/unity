...
import SimpleJSON;
private var id_relay="ARE11";
private var state = 0;
public var cr_light1: GameObject;
public var cr_light2: GameObject;
...
{	
	...
	if (request.error != null)
	{
    		...
    		cr_light1.gameObject.SetActive (false);
    		cr_light2.gameObject.SetActive (false);
       		state = 0;
	}
	else
	{
    		...
    		if (res2["value"].AsInt == 0){
    		  ...
    		  state=1;
    		  cr_light1.gameObject.SetActive (true);
    		cr_light2.gameObject.SetActive (true);
		     }
